...
#define RX_I2S_BCLK   32    // connect with I2S microphone pin SCK  (bit clock)
#define RX_I2S_LRC    25    // connect with I2S microphone pin WS   (word select)

char BT_SINK_NAME[]   = "Rockerz 370";        // set your sink devicename here
